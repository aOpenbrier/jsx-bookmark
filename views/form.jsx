            ...
            <div className="container">
                ...
                <form>
                    ...
                    <div className="form-group">
                        ...
                        <input type="number" className="form-control" id="bookCurPage"/>
                    </div>
                    <div className="form-group">
                        <label htmlFor="bookTotPages">Total Pages</label>
                        <input type="number" className="form-control" id="bookTotPages"/>
                    </div>
                    <div className="form-group form-check">
                        <input type="checkbox" className="form-check-input" id="bookReadCheck"/>
                        <label className="form-check-label" htmlFor="bookReadCheck">Already Read</label>
                    </div>
                    <button type="submit" className="btn btn-info mx-1" id="bookSubmit">Submit</button>
